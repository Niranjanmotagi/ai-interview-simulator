...
/**
 * Reference aesthetic: white card, thin dark border, hard offset shadow,
 * generous rounding. Pass `plain` for borderless pastel/bento tiles.
 */
...
>(({ className, plain, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      plain ? 'rounded-3xl' : 'border-2 border-zinc-900/90 shadow-hard',
      className,
    )}
    {...props}
  />
